...
use crate::{DeltaResult, DeltaResultIteratorStatic, Engine, PredicateRef};
...
impl CommitReader {
    ...
    /// - `predicate`: Optional scan predicate forwarded as an engine hint
    pub(crate) fn try_new(
        ...
        let actions = engine
            .json_handler()
            .read_json_files(&commit_files, schema, predicate)?
